#include "CALotus.h"
#include "CALotus_pieces.h"
#include "../CAObject.h"
#include "../CAPiece.h"
#include "../../CATexture.h"
#include "../../CAMaterial.h"

CALotus::CALotus(CAVulkanState* vulkan, VkDescriptorSetLayout layout)
{
	...
	vulkan->createTexture("textures/coches/Lotus/lo0_main.tga", &textures[0]);

	vulkan->createTexture("textures/coches/generic_main.tga", &textures[1]);

	vulkan->createTexture("textures/coches/Lotus/lo0_wheel.tga", &textures[2]);
...
int CALotus::GetNumPieces()
{
	return 67;
}

CAPiece* CALotus::GetPiece(int index)
{
	return pieces[index];
}
