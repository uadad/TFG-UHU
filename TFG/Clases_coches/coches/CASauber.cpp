...
CASauber::CASauber(CAVulkanState* vulkan, VkDescriptorSetLayout layout)
{
	...
	vulkan->createTexture("textures/coches/Sauber/sa0_main.tga", &textures[0]);

	vulkan->createTexture("textures/coches/generic_main.tga", &textures[1]);

	vulkan->createTexture("textures/coches/Sauber/sa0_wheel.tga", &textures[2]);
...
int CASauber::GetNumPieces()
{
	return 68;
}

CAPiece* CASauber::GetPiece(int index)
{
	return pieces[index];
}
