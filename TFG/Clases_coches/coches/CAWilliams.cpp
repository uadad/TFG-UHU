#include "CAWilliams.h"
#include "CAWilliams_pieces.h"
#include "../CAObject.h"
#include "../CAPiece.h"
#include "../../CATexture.h"
#include "../../CAMaterial.h"

CAWilliams::CAWilliams(CAVulkanState* vulkan, VkDescriptorSetLayout layout)
{
	...
	vulkan->createTexture("textures/coches/Williams/wi0_main.tga", &textures[0]);

	vulkan->createTexture("textures/coches/generic_main.tga", &textures[1]);

	vulkan->createTexture("textures/coches/Williams/wi0_wheel.tga", &textures[2]);
...
int CAWilliams::GetNumPieces()
{
	return 66;
}

CAPiece* CAWilliams::GetPiece(int index)
{
	return pieces[index];
}
