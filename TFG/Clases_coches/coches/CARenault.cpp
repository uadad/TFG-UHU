#include "CARenault.h"
#include "CARenault_pieces.h"
#include "../CAObject.h"
#include "../CAPiece.h"
#include "../../CATexture.h"
#include "../../CAMaterial.h"

CARenault::CARenault(CAVulkanState* vulkan, VkDescriptorSetLayout layout)
{
	...
	vulkan->createTexture("textures/coches/Renault/re0_main.tga", &textures[0]);

	vulkan->createTexture("textures/coches/generic_main.tga", &textures[1]);

	vulkan->createTexture("textures/coches/Renault/re0_wheel.tga", &textures[2]);
...
int CARenault::GetNumPieces()
{
	return 68;
}

CAPiece* CARenault::GetPiece(int index)
{
	return pieces[index];
}
