#include "CAForceIndia.h"
#include "CAForceIndia_pieces.h"
#include "../CAObject.h"
#include "../CAPiece.h"
#include "../../CATexture.h"
#include "../../CAMaterial.h"

CAForceIndia::CAForceIndia(CAVulkanState* vulkan, VkDescriptorSetLayout layout)
{
	...
	vulkan->createTexture("textures/coches/ForceIndia/fc0_main.tga", &textures[0]);

	vulkan->createTexture("textures/coches/generic_main.tga", &textures[1]);

	vulkan->createTexture("textures/coches/ForceIndia/fc0_wheel.tga", &textures[2]);
...
int CAForceIndia::GetNumPieces()
{
	return 71;
}

CAPiece* CAForceIndia::GetPiece(int index)
{
	return pieces[index];
}
