...
CAMclaren::CAMclaren(CAVulkanState* vulkan, VkDescriptorSetLayout layout)
{
	...
	vulkan->createTexture("textures/coches/Mclaren/mc0_main.tga", &textures[0]);

	vulkan->createTexture("textures/coches/generic_main.tga", &textures[1]);

	vulkan->createTexture("textures/coches/Mclaren/mc0_wheel.tga", &textures[2]);
...
int CAMclaren::GetNumPieces()
{
	return 68;
}

CAPiece* CAMclaren::GetPiece(int index)
{
	return pieces[index];
}
