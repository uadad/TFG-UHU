#include "CARedbull.h"
#include "CARedbull_pieces.h"
#include "../CAObject.h"
#include "../CAPiece.h"
#include "../../CATexture.h"
#include "../../CAMaterial.h"

CARedbull::CARedbull(CAVulkanState* vulkan, VkDescriptorSetLayout layout)
{
	...
	vulkan->createTexture("textures/coches/Redbull/rb0_main.tga", &textures[0]);

	vulkan->createTexture("textures/coches/generic_main.tga", &textures[1]);

	vulkan->createTexture("textures/coches/Redbull/rb0_wheel.tga", &textures[2]);
...
int CARedbull::GetNumPieces()
{
	return 67;
}

CAPiece* CARedbull::GetPiece(int index)
{
	return pieces[index];
}
