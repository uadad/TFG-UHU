#include "CAMercedes.h"
#include "CAMercedes_pieces.h"
#include "../CAObject.h"
#include "../CAPiece.h"
#include "../../CATexture.h"
#include "../../CAMaterial.h"

CAMercedes::CAMercedes(CAVulkanState* vulkan, VkDescriptorSetLayout layout)
{
	...
	vulkan->createTexture("textures/coches/Mercedes/me0_main.tga", &textures[0]);

	vulkan->createTexture("textures/coches/generic_main.tga", &textures[1]);

	vulkan->createTexture("textures/coches/Mercedes/me0_wheel.tga", &textures[2]);
...
CAMercedes::~CAMercedes()
{
	for (int i = 0; i < 66; i++) delete pieces[i];
	delete[] pieces;
	delete[] textures;
	delete[] mtl;
}

int CAMercedes::GetNumPieces()
{
	return 66;
}

CAPiece* CAMercedes::GetPiece(int index)
{
	return pieces[index];
}
